// Email template sent from the CTA slide as the follow-up after a BDM
// meeting. The backend send endpoint should call buildEmail() to get the
// rendered subject + body, then hand off to whichever transport (SES,
// Postmark, Gmail API, …) is wired up.
