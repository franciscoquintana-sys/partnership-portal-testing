...
const INVESTORS = [
  ...
  { name: 'Global PayTech Ventures', slug: 'global-paytech-ventures', imgStyle: { height: '76px', maxWidth: '180px' }, style: { fontWeight: 600, letterSpacing: '0.4px', fontSize: '0.78em', textTransform: 'uppercase' } },
]
...
export default function SlideTrustedBy() {
  ...
  return (
    <SlideBase section="About Yuno" slideNumber={8}>
      ...
      <div style={styles.body}>
        <div className="reveal" style={{ ...styles.merchantSection, '--reveal-delay': '0.18s' }}>
          <SectionHeader beamDelay={0} styles={styles}>Our Customers</SectionHeader>
          <div
            className="stagger"
            style={{
              ...styles.merchantGrid,
        ...
        <div className="reveal" style={{ ...styles.investorSection, '--reveal-delay': '0.85s' }}>
          <SectionHeader beamDelay={4} styles={styles}>Backed by world-class investors</SectionHeader>
