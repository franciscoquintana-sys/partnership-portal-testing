...
export default function SlideCountryDetailPage({ selectedCountry, merchantVertical }) {
  ...
  const REG_OVERRIDES = {
    'Brazil': [
      ...
      'Verticals — most fine. Licensed (separate flow): iGaming & sports betting (Bets.gov.br, 2024), crypto, adult, alcohol & pharma (age-gated).',
    ...
    'India': [
      ...
      'Verticals — pharma / fashion / electronics fine. Banned/restricted: real-money gaming & betting (state laws diverge), crypto as payment, adult, alcohol & tobacco online. Fantasy sports (skill) OK.',
    ...
    'Mexico': [
      ...
      'Verticals — most fine. Licensed: sports betting & online casino (DGJS/SEGOB), adult. Restricted: crypto as merchant settlement (Banxico), prescription pharma (COFEPRIS).',
    ...
    'United States': [
      ...
      'Verticals — most fine. State-licensed: online casino (NJ/MI/PA/CT/WV), sports betting (~40 states), adult (state age-verification), firearms. Network-blocked: cannabis (federally Schedule I).',
    ...
    'UAE': [
      ...
      'Verticals — most fine. Licensed: crypto under VARA (Dubai) / FSRA (ADGM). Prohibited: gambling, adult, alcohol online outside licensed channels.',
    ...
    'Germany': [
      ...
      'Verticals — most fine. Licensed: gambling (GlüStV, 2021), crypto (MiCA, 2024), adult (strict youth-protection rules), pharma via licensed online pharmacies.',
    ...
    'Indonesia': [
      ...
      'Verticals — most fine. Crypto trading legal via Bappebti (not as a payment method). Prohibited: gambling (Kominfo blocks), adult. Pharma e-commerce restricted via BPOM.',
    ...
    'Argentina': [
      ...
      'Verticals — most fine. Gambling licensed by province (CABA, Buenos Aires, Mendoza). Crypto legal (not tender) — highest per-capita stablecoin user in LatAm.',
    ...
    'Chile': [
      ...
      'Verticals — most fine. Licensed: gambling via casino concessions, crypto under LMSF (rare at checkout), adult. Pharma prescription via ISP.',
    ...
    'Colombia': [
      ...
      'Verticals — most fine. Gambling under Coljuegos (one of the more orderly LatAm regimes). Crypto legal but unregulated as payment. Pharma prescription via INVIMA.',
    ...
    'Peru': [
      ...
      'Verticals — most fine. Gambling under MINCETUR (sports-betting law, 2023). Crypto unregulated (BCRP warnings). Pharma prescription via DIGEMID.',
    ...
    'United Kingdom': [
      ...
      'Verticals — most fine. Licensed: gambling under UKGC (strictest in the world — affordability checks, stake caps). Adult licensed (Online Safety Act 2025 age-verification).',
    ...
    'France': [
      ...
      'Verticals — most fine. Licensed: gambling under ANJ (sports, poker, horse racing only — online casinos prohibited). Crypto under MiCA. Adult (Arcom age-verification since 2024).',
    ...
    'Italy': [
      ...
      'Verticals — most fine. Licensed: gambling under ADM (one of Europe’s largest regulated markets — casino, sports, poker, bingo). Crypto under MiCA + CONSOB/OAM. Tobacco is state-monopoly.',
    ...
    'Spain': [
      ...
      'Direct entry — not required for EU sellers under VAT OSS. Non-EU sellers appoint a fiscal representative.',
      'Verticals — most fine. Licensed: gambling under DGOJ (since 2012), crypto under MiCA (CNMV + BdE joint oversight). Tobacco state-monopoly — online sale prohibited.',
    ...
    'Japan': [
      ...
      'Verticals — most fine. Licensed: crypto under FIEA (strictest globally), adult (age + censorship laws). Prohibited: gambling outside public lotteries and pari-mutuel.',
    ...
    'Singapore': [
      ...
      'Verticals — most fine. Licensed: crypto under PSA (DPT services strictly regulated; public marketing banned). Prohibited: gambling outside Singapore Pools / Turf Club, adult (blocked).',
    ...
    'Thailand': [
      ...
      'Verticals — most fine. Licensed: crypto under SEC Thailand. Prohibited (criminal): gambling outside state lottery + horse racing, adult (blocked), pharma online sale.',
    ...
    'Vietnam': [
      ...
      'Verticals — most fine. Prohibited (criminal): gambling, adult (Decree 72 blocks). Restricted: pharma online (MoH). Crypto legal-grey, not a permitted payment method.',
    ...
    'Philippines': [
      ...
      'Verticals — most fine. Licensed: gambling under PAGCOR (POGO offshore ops banned 2024; domestic eGames licensed). Crypto under BSP VASP framework. Adult prohibited.',
    ...
    'Australia': [
      ...
      'Verticals — most fine. Licensed: gambling under IGA (sports & race wagering — online casino prohibited). Crypto under ASIC + AUSTRAC. Adult permitted (federal age-verification trial 2025).',
    ...
    'South Africa': [
      ...
      'Verticals — most fine. Licensed: sports betting (provincial), crypto under FSCA (VASP licensing since 2023), adult. Prohibited: online casino at national level.',
    ...
    'Nigeria': [
      ...
      'Verticals — most fine. Licensed: gambling via NLRC + state authorities. Crypto partially reopened 2023 with VASP framework. Adult prohibited.',
    ...
    'Kenya': [
      ...
      'Verticals — most fine. Licensed: gambling under BCLB. Crypto not legal tender — VASP framework in development. Adult permitted.',
    ...
    'Egypt': [
      ...
      'Verticals — most fine. Prohibited: gambling, crypto as payment instrument (CBE directive), adult.',
    ...
    'Qatar': [
      ...
      'Verticals — limited. Prohibited: gambling, alcohol-online, adult. Crypto unregulated. Pharma online via MoPH-licensed pharmacies.',
    ...
    'Bahrain': [
      ...
      'Verticals — most fine. Licensed: crypto under CBB Digital Assets framework (2019 — Rain, CoinMENA registered). Prohibited: gambling, adult. Alcohol-online via licensed channels only.',
    ...
    'Israel': [
      ...
      'Verticals — most fine. Licensed: crypto under ISA (exchange licensing). Adult permitted. Restricted: gambling outside state operators (Mifal Hapayis, Toto). Pharma prescription-only.',
    ...
    'Kuwait': [
      ...
      'Verticals — limited. Prohibited: gambling (Islamic finance), alcohol, adult. Crypto unregulated.',
    ...
    'Oman': [
      ...
      'Verticals — limited. Prohibited: gambling, alcohol-online, adult. Crypto unregulated. Pharma online via MoH-licensed pharmacies.',
    ...
    'Jordan': [
      ...
      'Verticals — limited. Prohibited or restricted: gambling, adult. Crypto unregulated. Pharma online via JFDA-licensed pharmacies.',
    ...
    'Turkey': [
      ...
      'Verticals — limited. Gambling: state monopoly only (İddaa, Milli Piyango). Crypto banned as payment since 2021 (legal for investing). Restricted: adult (BTK blocks), pharma online (state pharmacy monopoly).',
