...
function ArchitectureStack({ merchantName, merchantLogo, isTileLogo, psps, styles, theme }) {
    ...
    <div ref={containerRef} style={styles.archStack}>
      ...
      <div ref={yunoRef} style={styles.archYunoBlock}>
        <div style={styles.archYunoTitleRow}>
          ...
          <img src="/connections-deck/assets/yuno-wordmark-white.svg" alt="Yuno" style={styles.archYunoWordmark} />
      ...
      <div className="stagger" style={{ ...styles.archPspsRow, '--stagger-base': '0.45s', '--stagger-step': '0.06s' }}>
        {chips.map((p, i) => (
          <div
            key={p}
        ...
        >
          ...
          {chips.length > 0 && (
            <span style={styles.archPspChipMoreLabel}>more</span>
          )}
        </div>
      </div>
      <div style={styles.archIllustrativeNote}>&gt; illustrative, non-exhaustive</div>
    </div>
  )
}

function CapCard({ num, title, desc, styles, theme }) {
    ...
    >
      ...
      >
        <div style={frontFace}>
          ...
          <span style={styles.capFlipHint}>{num} &middot; tap</span>
        </div>
  ...
  return (
    ...
    >
      <h2 style={styles.title}>
        {isBanking ? (
          <>
            What your bank gains <span style={styles.accent}>the day you plug in</span>
          </>
        ) : (
          <>
      ...
      <div style={styles.body}>
        ...
        <div style={styles.mainRow}>
              ...
              <div style={styles.archHeaderRow}>
                <div>
                  <div style={styles.archLabel}>
                    {isBanking ? 'Under your brand'
                      : isPartner ? 'What we deliver to merchants today'
                      : 'With Yuno'}
                  </div>
                  <div style={styles.archTitle}>
                    {isBanking ? 'One control plane for your merchants'
                      : isPartner ? 'One control plane, every PSP, every market'
                      : `One control plane for ${data.COMPANY_NAME}`}
                  </div>
                </div>
                <div style={styles.archBadge}>
                  <span style={styles.archBadgeDot} />
                  {isBanking ? 'Your Brand' : 'Live'}
                </div>
              </div>
              <ArchitectureStack
          ...
          <div style={styles.rightPanel}>
            ...
            <div className="stagger" style={{ ...styles.capList, '--stagger-base': '0.3s', '--stagger-step': '0.09s' }}>
              {caps.map((c) => (
                <CapCard key={c.num} num={c.num} title={c.title} desc={c.desc} styles={styles} theme={theme} />
              ))}
            </div>
          </div>
        </div>
        ...
        <div style={styles.impactSection}>
          ...
          <div style={styles.bottomSource}>&gt; Yuno merchants, historical average</div>
        </div>
      </div>
    </SlideBase>
  )
