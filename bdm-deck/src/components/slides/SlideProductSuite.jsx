...
function PaymentsConciergeHero({ styles, theme }) {
  return (
    <div style={styles.heroCard}>
      <div style={styles.heroHeader}>
        ...
        <div style={styles.heroHeaderLabel}>
          <img
            src="/connections-deck/logos/pc-logomark.svg"
            alt=""
            style={{
          ...
          />
          <span style={styles.heroHeaderText}>Payments Concierge</span>
        </div>
      </div>
      ...
      <div style={styles.heroBody}>
        ...
        >
          ...
          <div style={styles.heroAiBubble}>
            Want me to recommend some actions to take?
          </div>
        </div>
      </div>
    </div>
...
export default function SlideProductSuite() {
      ...
      <div className="stagger" style={{ ...styles.body, '--stagger-base': '0.1s', '--stagger-step': '0.1s' }}>
        ...
        <div className="stagger" style={{ ...styles.grid, '--stagger-base': '0.55s', '--stagger-step': '0.1s' }}>
          ...
          <div style={{ ...styles.column, ...styles.aiColumn }}>
            ...
            <PillarHeader pillar={AI_PILLAR} index={3} styles={styles} />
            <div style={styles.itemsList}>
              {AI_PILLAR.items.map((item) => (
                <PillarItem
                  key={item.title}
                  item={item}
                  color={AI_PILLAR.color}
                  soft={AI_PILLAR.soft}
                  border={AI_PILLAR.border}
                  styles={styles}
                  theme={theme}
                />
              ))}
          ...
          <div style={styles.pcCard}>
            <div style={styles.pcInfo}>
              ...
              <p style={styles.pcDescription}>
                Natural-language copilot for payments ops. Ask anything, get
                decisions, not just dashboards.
              </p>
            </div>
            <PaymentsConciergeHero styles={styles} theme={theme} />
          </div>
        </div>
      </div>
    </SlideBase>
