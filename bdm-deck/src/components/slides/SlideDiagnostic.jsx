...
export default function SlideDiagnostic({ data }) {
  ...
  return (
    <SlideBase section={isBanking ? 'Banking Vertical' : isPartner ? 'Partner Program' : 'Payments Diagnostic'} slideNumber={3}>
      <h2 style={styles.title}>
        {isBanking ? (
          <>
            We understand how your bank{' '}
            <span style={styles.titleAccent}>operates today</span>
          </>
        ) : isPartner ? (
          <>
            We understand how{' '}
          ...
          <>
            ...
            <span style={styles.titleAccent}>{data.COMPANY_NAME}&rsquo;s situation</span>
          </>
        )}
      </h2>
          ...
          >
            <div style={styles.diagHeaderRow}>
              <div style={styles.diagHeaderLeft}>
                <div style={styles.diagLabel}>{isBanking ? 'Your stack today' : isPartner ? 'Your distribution' : 'Diagnostic'}</div>
                <div style={styles.diagTitle}>{isBanking ? 'This is your current topology' : isPartner ? 'How you reach merchants today' : "Today's topology"}</div>
              </div>
            ...
            <div style={styles.topology}>
              ...
              {psps.length > 0 ? (
                <>
                  ...
                  <div style={styles.illustrativeNote}>&gt; illustrative, non-exhaustive</div>
                </>
              ) : (
                <>
              ...
              <>
                ...
                <div style={styles.capabilitiesSection}>
                  <div style={styles.capabilitiesHeaderRow}>
                    <span style={styles.capabilitiesLabel}>{isPartner ? 'Ecosystem coverage' : 'Capability stack'}</span>
            ...
            <div style={styles.methodsSection}>
              <div style={styles.methodsHeaderRow}>
                <span style={styles.methodsLabel}>
                  {isBanking ? 'What Yuno adds under your brand'
                    : isPartner ? 'Gaps in your current go-to-market'
              ...
              <div style={styles.illustrativeNote}>&gt; non-exhaustive</div>
            </div>
          </div>
        </div>
