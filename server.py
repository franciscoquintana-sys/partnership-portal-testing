...
COUNTRY_DETAIL_RICH = {
    ...
    "Canada": {
        ...
        "local_payments": {
            "scheme":  "Interac (debit + e-transfer)",
    ...
    "Iran": {
        ...
        "local_payments": {
            "scheme":  "Shaparak / Shetab (domestic)",
            "a2a":     "Paya / Satna",
            "apms":    [
    ...
    "Indonesia": {
        ...
        "local_payments": {
            "scheme":  "GPN (Gerbang Pembayaran Nasional)",
            "a2a":     "BI-FAST",
            "apms":    [
    ...
    "Pakistan": {
        ...
        "payment_methods_breakdown": [
            ...
            {"name": "Credit / Debit Cards", "share": 15, "growth": "+6% YoY",
                "schemes": [
                    {"name": "Visa",       "share":  6.0, "type": "international"},
                    {"name": "Mastercard", "share":  5.0, "type": "international"},
                    {"name": "PayPak",     "share":  4.0, "type": "local"},
                ]},
    ...
    "Sri Lanka": {
        ...
        "payment_methods_breakdown": [
            ...
            {"name": "Credit / Debit Cards", "share": 25, "growth": "+4% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 13.0, "type": "international"},
                    {"name": "Mastercard", "share": 10.0, "type": "international"},
                    {"name": "Amex",       "share":  2.0, "type": "international"},
    ...
    "Nepal": {
        ...
        "payment_methods_breakdown": [
            ...
            {"name": "Cards", "share": 12, "growth": "+5% YoY",
                "schemes": [
                    {"name": "Visa",       "share":  6.0, "type": "international"},
                    {"name": "Mastercard", "share":  5.0, "type": "international"},
                    {"name": "SCT",        "share":  1.0, "type": "local"},
                ]},
    ...
    "Cambodia": {
        ...
        "payment_methods_breakdown": [
            ...
            {"name": "Cards", "share": 12, "growth": "+6% YoY",
                "schemes": [
                    {"name": "Visa",       "share":  6.0, "type": "international"},
    ...
    "United Kingdom": {
        ...
        "local_payments": {
            "scheme":  "Visa/Mastercard (no dedicated domestic)",
    ...
    "Germany": {
        ...
        "local_payments": {
            "scheme":  "girocard (domestic debit)",
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "detail": "Credit + debit + girocard", "share": 30, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 12.0, "type": "international"},
                    {"name": "Mastercard", "share": 10.0, "type": "international"},
                    {"name": "girocard",   "share":  7.0, "type": "local"},
                    {"name": "Amex",       "share":  1.0, "type": "international"},
                ]},
    ...
    "France": {
        ...
        "local_payments": {
            "scheme":  "Cartes Bancaires (CB, co-badged)",
            "a2a":     "SEPA Instant",
            "apms":    [
                {"name": "PayPal",    "type": "Wallet"},
                {"name": "Apple Pay", "type": "Wallet"},
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "detail": "CB co-badged with Visa/MC", "share": 55, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 25.0, "type": "international"},
                    {"name": "Mastercard", "share": 20.0, "type": "international"},
                    {"name": "CB",         "share":  8.0, "type": "local"},
                    {"name": "Amex",       "share":  2.0, "type": "international"},
                ]},
    ...
    "Spain": {
        ...
        "local_payments": {
            "scheme":  "Visa/Mastercard (Redsys processes)",
            "a2a":     "Bizum",
            "apms":    [
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 48, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 25.0, "type": "international"},
                    {"name": "Mastercard", "share": 20.0, "type": "international"},
                    {"name": "Amex",       "share":  3.0, "type": "international"},
    ...
    "Italy": {
        ...
        "local_payments": {
            "scheme":  "Bancomat (domestic debit) + PagoBancomat",
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "detail": "Credit + Bancomat debit", "share": 48, "growth": "+4% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 22.0, "type": "international"},
                    {"name": "Mastercard", "share": 18.0, "type": "international"},
                    {"name": "Bancomat",   "share":  6.0, "type": "local"},
                    {"name": "Amex",       "share":  2.0, "type": "international"},
                ]},
    ...
    "Netherlands": {
        ...
        "local_payments": {
            "scheme":  "Maestro (phasing out) → V Pay / Mastercard",
            "a2a":     "iDEAL (dominant)",
            "apms":    [
        ...
        "payment_methods_breakdown": [
            ...
            {"name": "Cards", "share": 12, "growth": "+2% YoY",
                "schemes": [
                    {"name": "Visa",       "share":  6.0, "type": "international"},
                    {"name": "Mastercard", "share":  5.0, "type": "international"},
                    {"name": "Amex",       "share":  1.0, "type": "international"},
    ...
    "Belgium": {
        ...
        "local_payments": {
            "scheme":  "Bancontact (domestic debit, dominant)",
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "detail": "Bancontact + Visa/MC", "share": 55, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Bancontact", "share": 32.0, "type": "local"},
                    {"name": "Visa",       "share": 13.0, "type": "international"},
    ...
    "Portugal": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 35, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 18.0, "type": "international"},
                    {"name": "Mastercard", "share": 14.0, "type": "international"},
                    {"name": "Amex",       "share":  3.0, "type": "international"},
    ...
    "Ireland": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 48, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 26.0, "type": "international"},
                    {"name": "Mastercard", "share": 18.0, "type": "international"},
                    {"name": "Amex",       "share":  4.0, "type": "international"},
                ]},
    ...
    "Austria": {
        ...
        "local_payments": {
            "scheme":  "Bankomat (domestic debit)",
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "detail": "Bankomat + Visa/MC", "share": 40, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 18.0, "type": "international"},
                    {"name": "Mastercard", "share": 13.0, "type": "international"},
                    {"name": "Bankomat",   "share":  8.0, "type": "local"},
                    {"name": "Amex",       "share":  1.0, "type": "international"},
                ]},
    ...
    "Switzerland": {
        ...
        "local_payments": {
            "scheme":  "Visa/Mastercard (no domestic)",
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 40, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 20.0, "type": "international"},
                    {"name": "Mastercard", "share": 16.0, "type": "international"},
                    {"name": "Amex",       "share":  3.0, "type": "international"},
    ...
    "Sweden": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 40, "growth": "+2% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 22.0, "type": "international"},
                    {"name": "Mastercard", "share": 16.0, "type": "international"},
                    {"name": "Amex",       "share":  2.0, "type": "international"},
    ...
    "Norway": {
        ...
        "local_payments": {
            "scheme":  "BankAxept (domestic debit)",
            "a2a":     "Vipps (dominant)",
            "apms":    [
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "detail": "BankAxept + Visa/MC", "share": 45, "growth": "+2% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 20.0, "type": "international"},
                    {"name": "Mastercard", "share": 15.0, "type": "international"},
                    {"name": "BankAxept",  "share":  8.0, "type": "local"},
                    {"name": "Amex",       "share":  2.0, "type": "international"},
                ]},
    ...
    "Denmark": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "detail": "Dankort + Visa/MC", "share": 45, "growth": "+2% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 22.0, "type": "international"},
                    {"name": "Mastercard", "share": 14.0, "type": "international"},
                    {"name": "Dankort",    "share":  8.0, "type": "local"},
                    {"name": "Amex",       "share":  1.0, "type": "international"},
                ]},
    ...
    "Finland": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 45, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 23.0, "type": "international"},
                    {"name": "Mastercard", "share": 18.0, "type": "international"},
                    {"name": "Amex",       "share":  4.0, "type": "international"},
    ...
    "Poland": {
        ...
        "payment_methods_breakdown": [
            ...
            {"name": "Cards", "share": 28, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 14.0, "type": "international"},
                    {"name": "Mastercard", "share": 12.0, "type": "international"},
                    {"name": "Amex",       "share":  2.0, "type": "international"},
    ...
    "Czech Republic": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 50, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 24.0, "type": "international"},
                    {"name": "Mastercard", "share": 22.0, "type": "international"},
                    {"name": "Amex",       "share":  4.0, "type": "international"},
                ]},
    ...
    "Romania": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 38, "growth": "+5% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 19.0, "type": "international"},
                    {"name": "Mastercard", "share": 16.0, "type": "international"},
                    {"name": "Amex",       "share":  3.0, "type": "international"},
    ...
    "Greece": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 55, "growth": "+4% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 28.0, "type": "international"},
                    {"name": "Mastercard", "share": 22.0, "type": "international"},
                    {"name": "Amex",       "share":  4.0, "type": "international"},
                    {"name": "Diners",     "share":  1.0, "type": "international"},
                ]},
    ...
    "Ukraine": {
        ...
        "local_payments": {
            "scheme":  "PROSTIR (ProstirUkr, domestic)",
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 55, "growth": "+4% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 28.0, "type": "international"},
                    {"name": "Mastercard", "share": 22.0, "type": "international"},
                    {"name": "PROSTIR",    "share":  5.0, "type": "local"},
                ]},
    ...
    "Bulgaria": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 45, "growth": "+4% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 22.0, "type": "international"},
                    {"name": "Mastercard", "share": 18.0, "type": "international"},
                    {"name": "Borica",     "share":  3.0, "type": "local"},
                    {"name": "Amex",       "share":  2.0, "type": "international"},
                ]},
    ...
    "Croatia": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 55, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 28.0, "type": "international"},
                    {"name": "Mastercard", "share": 22.0, "type": "international"},
                    {"name": "Amex",       "share":  5.0, "type": "international"},
    ...
    "Slovakia": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 52, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 26.0, "type": "international"},
                    {"name": "Mastercard", "share": 22.0, "type": "international"},
                    {"name": "Amex",       "share":  4.0, "type": "international"},
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 50, "growth": "+3% YoY",
                "schemes": [
                    ...
                    {"name": "Mastercard", "share": 20.0, "type": "international"},
                    {"name": "Amex",       "share":  3.0, "type": "international"},
                    {"name": "Diners",     "share":  2.0, "type": "international"},
                ]},
            {"name": "A2A", "share": 20, "growth": "+22% YoY"},
            {"name": "Cash", "share": 12, "growth": "-8% YoY"},
            {"name": "Wallets", "share": 10, "growth": "+22% YoY"},
    ...
    "Estonia": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 50, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 26.0, "type": "international"},
                    {"name": "Mastercard", "share": 21.0, "type": "international"},
                    {"name": "Amex",       "share":  3.0, "type": "international"},
                ]},
    ...
    "Iceland": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 65, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 34.0, "type": "international"},
                    {"name": "Mastercard", "share": 26.0, "type": "international"},
                    {"name": "Amex",       "share":  5.0, "type": "international"},
                ]},
    ...
    "Cyprus": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 58, "growth": "+4% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 30.0, "type": "international"},
                    {"name": "Mastercard", "share": 23.0, "type": "international"},
                    {"name": "Amex",       "share":  4.0, "type": "international"},
                    {"name": "Diners",     "share":  1.0, "type": "international"},
                ]},
    ...
    "Malta": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 60, "growth": "+3% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 31.0, "type": "international"},
                    {"name": "Mastercard", "share": 23.0, "type": "international"},
                    {"name": "Amex",       "share":  4.0, "type": "international"},
                    {"name": "Diners",     "share":  2.0, "type": "international"},
                ]},
    ...
    "Serbia": {
        ...
        "payment_methods_breakdown": [
            {"name": "Cards", "share": 42, "growth": "+5% YoY",
                "schemes": [
                    {"name": "Visa",       "share": 20.0, "type": "international"},
                    {"name": "Mastercard", "share": 16.0, "type": "international"},
                    {"name": "DinaCard",   "share":  4.0, "type": "local"},
                    {"name": "Amex",       "share":  2.0, "type": "international"},
                ]},
            {"name": "Cash", "share": 25, "growth": "-8% YoY"},
    ...
    "Myanmar": {
        ...
        "local_payments": {
            "scheme":  "MPU (Myanmar Payment Union)",
            "a2a":     "CBM-NET",
            "apms":    [
        ...
        "payment_methods_breakdown": [
            ...
            {"name": "Cards", "detail": "MPU + Visa/MC", "share": 10, "growth": "+5% YoY",
                "schemes": [
                    {"name": "MPU",        "share":  5.0, "type": "local"},
