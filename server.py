...
# Translates a batch of English strings into the target language via Google's
# unofficial translate endpoint (no API key required). Each string goes
# through one HTTP call; results are cached server-side so the second visit
# to any slide is instant. The deck calls this after each slide render to
# translate visible text in place.
_TRANSLATION_CACHE: dict = {}
_GOOGLE_TRANSLATE_URL = "https://translate.googleapis.com/translate_a/single"


def _google_translate(text: str, target: str) -> str:
    """Translate a single string via Google's free `translate_a/single`
    endpoint. Returns the English original on any failure so the UI never
    shows a missing-string error."""
...
async def api_translate(request: Request):
    ...
    for t in texts:
        ...
        if key in _TRANSLATION_CACHE:
            out.append(_TRANSLATION_CACHE[key])
            continue
        translated = _google_translate(t, lang)
...
def introduction(request: Request):
    ...
    # Partners, PMs and merchants currently on the board (deduped, sorted) for the filters
    ...
    board_merchants = sorted({(i.get("merchant") or "").strip() for i in INTROS if (i.get("merchant") or "").strip()})
...
COUNTRY_PARTNERS = {
    # ---- LATAM ----
    # Top 5 per market, prioritizing Yuno's actual partners (per the partnership
    ...
    "Peru":                [{"name":"Niubiz","type":"Acquirer"},{"name":"Izipay","type":"Acquirer"},{"name":"Culqi","type":"Acquirer"},{"name":"OpenPay Peru","type":"PSP"},{"name":"MercadoPago","type":"PSP"}],
    "Uruguay":             [{"name":"DLocal","type":"Acquirer"},{"name":"Fiserv Uruguay","type":"Acquirer"},{"name":"MercadoPago","type":"PSP"},{"name":"Totalnet (ex-Visanet)","type":"Acquirer"},{"name":"Plexo","type":"PSP"}],
    "Ecuador":             [{"name":"Datafast","type":"Acquirer"},{"name":"DeUna Wallet","type":"Acquirer"},{"name":"Diners Club del Ecuador","type":"Acquirer"},{"name":"Kushki","type":"Acquirer"},{"name":"MercadoPago","type":"PSP"}],
    "Bolivia":             [{"name":"MercadoPago","type":"PSP"},{"name":"Linkser","type":"Acquirer"},{"name":"ATC","type":"Acquirer"},{"name":"Visanet Bolivia","type":"Acquirer"},{"name":"Pagosnet","type":"PSP"}],
    "Paraguay":            [{"name":"Bancard","type":"Acquirer"},{"name":"Bepsa (Bepsa del Paraguay SAEC)","type":"Acquirer"},{"name":"Procard S.A.","type":"Acquirer"},{"name":"MercadoPago","type":"PSP"},{"name":"Pagopar","type":"PSP"}],
    "Venezuela":           [{"name":"Banco Mercantil","type":"Acquirer"},{"name":"R4 Banco Microfinanciero","type":"Acquirer"},{"name":"Banesco","type":"Acquirer"},{"name":"Cantv Pago","type":"Gateway"},{"name":"MercadoPago","type":"PSP"}],
    "Costa Rica":          [{"name":"BAC International Bank","type":"Acquirer"},{"name":"MercadoPago","type":"PSP"},{"name":"Tilopay","type":"PSP"},{"name":"BCR","type":"Acquirer"},{"name":"Banco Nacional","type":"Acquirer"}],
    ...
    "Trinidad and Tobago": [{"name":"FAC/Powertranz","type":"Acquirer"},{"name":"Republic Bank","type":"Acquirer"},{"name":"FCB","type":"Acquirer"},{"name":"Scotia T&T","type":"Acquirer"},{"name":"WiPay","type":"PSP"}],
    # ---- North America ----
    "United States":       [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Worldpay","type":"Acquirer"},{"name":"JP Morgan chase USA","type":"Acquirer"},{"name":"Bank of America","type":"Acquirer"}],
    "Canada":              [{"name":"Moneris","type":"Acquirer"},{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Worldpay","type":"Acquirer"},{"name":"Global Payments","type":"Acquirer"}],
    # ---- Europe ----
    ...
    "Belgium":             [{"name":"Adyen","type":"PSP"},{"name":"Worldline","type":"Acquirer"},{"name":"Stripe","type":"PSP"},{"name":"Mollie","type":"PSP"},{"name":"Hipay","type":"Acquirer"}],
    "Switzerland":         [{"name":"Adyen","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"Worldline","type":"Acquirer"},{"name":"Nexi","type":"Acquirer"},{"name":"Worldpay","type":"Acquirer"}],
    "Sweden":              [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Worldline","type":"Acquirer"},{"name":"Worldpay","type":"Acquirer"},{"name":"Trust Payments","type":"Acquirer"}],
    "Norway":              [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Worldline","type":"Acquirer"},{"name":"Worldpay","type":"Acquirer"},{"name":"Trust Payments","type":"Acquirer"}],
    "Denmark":             [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Worldline","type":"Acquirer"},{"name":"Worldpay","type":"Acquirer"},{"name":"Trust Payments","type":"Acquirer"}],
    "Finland":             [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Worldline","type":"Acquirer"},{"name":"Worldpay","type":"Acquirer"},{"name":"Trust Payments","type":"Acquirer"}],
    ...
    "Lithuania":           [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Worldline","type":"Acquirer"},{"name":"Worldpay","type":"Acquirer"},{"name":"Paysera","type":"PSP"}],
    "Luxembourg":          [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Worldline","type":"Acquirer"},{"name":"Worldpay","type":"Acquirer"},{"name":"Saferpay","type":"Gateway"}],
    "Iceland":             [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Worldline","type":"Acquirer"},{"name":"Borgun","type":"Acquirer"},{"name":"Valitor","type":"Acquirer"}],
    ...
    # ---- Middle East ----
    "UAE":                 [{"name":"Network International","type":"PSP"},{"name":"Checkout","type":"Acquirer"},{"name":"Tap Payments","type":"PSP"},{"name":"HyperPay","type":"PSP"},{"name":"Telr","type":"PSP"}],
    "Saudi Arabia":        [{"name":"Moyasar","type":"PSP"},{"name":"HyperPay","type":"PSP"},{"name":"Tap Payments","type":"PSP"},{"name":"Network International","type":"PSP"},{"name":"Checkout","type":"Acquirer"}],
    ...
    "Qatar":               [{"name":"Tap Payments","type":"PSP"},{"name":"Checkout","type":"Acquirer"},{"name":"HyperPay","type":"PSP"},{"name":"QPay","type":"PSP"},{"name":"MyFatoorah","type":"PSP"}],
    "Kuwait":              [{"name":"Tap Payments","type":"PSP"},{"name":"Checkout","type":"Acquirer"},{"name":"MyFatoorah","type":"PSP"},{"name":"PayTabs","type":"PSP"},{"name":"Telr","type":"PSP"}],
    "Bahrain":             [{"name":"Tap Payments","type":"PSP"},{"name":"Checkout","type":"Acquirer"},{"name":"HyperPay","type":"PSP"},{"name":"Pay10","type":"PSP"},{"name":"Telr","type":"PSP"}],
    "Oman":                [{"name":"Thawani Pay","type":"PSP"},{"name":"Tap Payments","type":"PSP"},{"name":"Checkout","type":"Acquirer"},{"name":"HyperPay","type":"PSP"},{"name":"PayTabs","type":"PSP"}],
    "Jordan":              [{"name":"HyperPay","type":"PSP"},{"name":"Network International","type":"PSP"},{"name":"PayTabs","type":"PSP"},{"name":"MyFatoorah","type":"PSP"},{"name":"ZoodPay","type":"PSP"}],
    "Lebanon":             [{"name":"HyperPay","type":"PSP"},{"name":"Areeba","type":"Acquirer"},{"name":"OMT Pay","type":"PSP"},{"name":"Whish","type":"PSP"},{"name":"Pinpay","type":"PSP"}],
    "Iraq":                [{"name":"HyperPay","type":"PSP"},{"name":"FastPay","type":"PSP"},{"name":"ZoodPay","type":"PSP"},{"name":"Nass E-Payment","type":"PSP"},{"name":"NassWallet","type":"PSP"}],
    "Egypt":               [{"name":"Paymob","type":"PSP"},{"name":"Fawry","type":"PSP"},{"name":"HyperPay","type":"PSP"},{"name":"Geidea","type":"PSP"},{"name":"DLocal","type":"Acquirer"}],
    # ---- APAC ----
    ...
    "Japan":               [{"name":"GMO","type":"PSP"},{"name":"SMCC","type":"PSP"},{"name":"NTTD","type":"Acquirer"},{"name":"DGFT","type":"PSP"},{"name":"Netstars","type":"PSP"}],
    ...
    "Taiwan":              [{"name":"ECPay","type":"PSP"},{"name":"Tappay","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"AsiaPay","type":"PSP"}],
    "Indonesia":           [{"name":"Xendit","type":"PSP"},{"name":"DANA","type":"PSP"},{"name":"Coda Payment","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"}],
    "Thailand":            [{"name":"2C2P / Ant Intl","type":"Acquirer"},{"name":"Opn Payments (Omise)","type":"PSP"},{"name":"Kasikorn Global Payment","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"}],
    "Philippines":         [{"name":"Maya","type":"PSP"},{"name":"AsiaPay","type":"PSP"},{"name":"2C2P / Ant Intl","type":"Acquirer"},{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"}],
    "Vietnam":             [{"name":"FinFan","type":"PSP"},{"name":"2C2P / Ant Intl","type":"Acquirer"},{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Worldline","type":"Acquirer"}],
    "Malaysia":            [{"name":"Fiuu.com","type":"PSP"},{"name":"HitPay","type":"PSP"},{"name":"2C2P / Ant Intl","type":"Acquirer"},{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"}],
    "Australia":           [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Monoova","type":"PSP"},{"name":"Airwallex APAC","type":"Acquirer"},{"name":"Worldpay","type":"Acquirer"}],
    "New Zealand":         [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Worldline","type":"Acquirer"},{"name":"Worldpay","type":"Acquirer"},{"name":"Airwallex APAC","type":"Acquirer"}],
    "Bangladesh":          [{"name":"2C2P / Ant Intl","type":"Acquirer"},{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"SSL Wireless","type":"PSP"},{"name":"BRAC Bank","type":"Acquirer"}],
    "Pakistan":            [{"name":"Simpaisa","type":"PSP"},{"name":"2C2P / Ant Intl","type":"Acquirer"},{"name":"Adyen","type":"PSP"},{"name":"JazzCash Business","type":"PSP"},{"name":"Easypaisa","type":"PSP"}],
    "Sri Lanka":           [{"name":"2C2P / Ant Intl","type":"Acquirer"},{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Commercial Bank","type":"Acquirer"},{"name":"PayHere","type":"PSP"}],
    "Nepal":               [{"name":"2C2P / Ant Intl","type":"Acquirer"},{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"Khalti","type":"PSP"},{"name":"FonePay","type":"Gateway"}],
    "Cambodia":            [{"name":"2C2P / Ant Intl","type":"Acquirer"},{"name":"Stripe","type":"PSP"},{"name":"Bakong","type":"Gateway"},{"name":"ABA Bank","type":"Acquirer"},{"name":"Acleda Bank","type":"Acquirer"}],
    "Myanmar":             [{"name":"2C2P / Ant Intl","type":"Acquirer"},{"name":"MPU","type":"Acquirer"},{"name":"KBZ Bank","type":"Acquirer"},{"name":"Wave Money","type":"PSP"},{"name":"OnePay Myanmar","type":"PSP"}],
    # ---- Africa ----
    "South Africa":        [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"DLocal","type":"Acquirer"},{"name":"Carry1st","type":"Acquirer"},{"name":"Onafriq","type":"PSP"}],
    "Nigeria":             [{"name":"Paystack by Stripe","type":"Acquirer"},{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"DLocal","type":"Acquirer"},{"name":"Flutterwave","type":"PSP"}],
    "Kenya":               [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"DLocal","type":"Acquirer"},{"name":"Pesapal","type":"PSP"},{"name":"DPO Group","type":"PSP"}],
    "Morocco":             [{"name":"DLocal","type":"Acquirer"},{"name":"CMI","type":"Acquirer"},{"name":"HPS","type":"PSP"},{"name":"Worldline","type":"Acquirer"},{"name":"Carry1st","type":"Acquirer"}],
    "Ghana":               [{"name":"Paystack by Stripe","type":"Acquirer"},{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"DLocal","type":"Acquirer"},{"name":"Hubtel","type":"PSP"}],
    "Ethiopia":            [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"ChaPa","type":"PSP"},{"name":"CBE","type":"Acquirer"},{"name":"Cooperative Bank","type":"Acquirer"}],
    "Tanzania":            [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"DLocal","type":"Acquirer"},{"name":"Selcom","type":"PSP"},{"name":"Pesapal","type":"PSP"}],
    "Uganda":              [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"DLocal","type":"Acquirer"},{"name":"Flutterwave","type":"PSP"},{"name":"Pesapal","type":"PSP"}],
    ...
    "Zimbabwe":            [{"name":"Stripe","type":"PSP"},{"name":"Paynow","type":"PSP"},{"name":"CBZ","type":"Acquirer"},{"name":"Stanbic Zim","type":"Acquirer"},{"name":"ZimSwitch","type":"Acquirer"}],
    "Botswana":            [{"name":"Stripe","type":"PSP"},{"name":"ABSA Bank","type":"Acquirer"},{"name":"BancABC","type":"Acquirer"},{"name":"Stanbic","type":"Acquirer"},{"name":"FNB Botswana","type":"Acquirer"}],
    "Mauritius":           [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"MIPS","type":"PSP"},{"name":"Mauritius Commercial Bank","type":"Acquirer"},{"name":"MauBank","type":"Acquirer"}],
    "Rwanda":              [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"DLocal","type":"Acquirer"},{"name":"Flutterwave","type":"PSP"},{"name":"Pesapal","type":"PSP"}],
    "Zambia":              [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"Tingg","type":"PSP"},{"name":"Pesapal","type":"PSP"},{"name":"Stanbic","type":"Acquirer"}],
}
