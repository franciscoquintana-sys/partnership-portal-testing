        ...
        "payment_methods_breakdown": [
            ...
            {"name": "Credit Cards",     "share": 8,  "growth": "+5% YoY",
                "schemes": [
                    ...
                    {"name": "Mastercard",    "share_of_category": 35, "type": "international"},
                    {"name": "RuPay",         "share_of_category": 10, "type": "local"},
                    {"name": "Amex / Diners", "share_of_category": 5,  "type": "international"},
                ]},
            {"name": "Debit Cards / Prepaid Cards", "share": 4, "growth": "flat",
                "schemes": [
                    {"name": "RuPay",      "share_of_category": 50, "type": "local"},
                    {"name": "Visa",       "share_of_category": 30, "type": "international"},
                    {"name": "Mastercard", "share_of_category": 20, "type": "international"},
                ]},
