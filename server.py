...
COUNTRY_PARTNERS = {
    ...
    "Bahrain":             [{"name":"Tap Payments","type":"PSP"},{"name":"Network International","type":"PSP"},{"name":"Checkout MENA","type":"Acquirer"},{"name":"BENEFIT","type":"Acquirer"},{"name":"NBB","type":"Acquirer"}],
    "Oman":                [{"name":"Thawani Pay","type":"PSP"},{"name":"Tap Payments","type":"PSP"},{"name":"Network International","type":"PSP"},{"name":"OmanNet","type":"Acquirer"},{"name":"Bank Muscat","type":"Acquirer"}],
    "Jordan":              [{"name":"HyperPay","type":"PSP"},{"name":"Tap Payments","type":"PSP"},{"name":"Network International","type":"PSP"},{"name":"MadfoatCom","type":"PSP"},{"name":"Arab Bank","type":"Acquirer"}],
    "Lebanon":             [{"name":"Tap Payments","type":"PSP"},{"name":"Network International","type":"PSP"},{"name":"Areeba","type":"Acquirer"},{"name":"Bank Audi","type":"Acquirer"},{"name":"BLF","type":"Acquirer"}],
    "Iraq":                [{"name":"Tap Payments","type":"PSP"},{"name":"Switch","type":"Acquirer"},{"name":"Qi Card","type":"Acquirer"},{"name":"KI Card","type":"Acquirer"},{"name":"TBI Pay","type":"PSP"}],
    "Egypt":               [{"name":"Paymob","type":"PSP"},{"name":"HyperPay","type":"PSP"},{"name":"Tap Payments","type":"PSP"},{"name":"Checkout MENA","type":"Acquirer"},{"name":"Fawry","type":"PSP"}],
    # ---- APAC ----
    ...
    # ---- Africa ----
    "South Africa":        [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"ABSA Bank","type":"Acquirer"},{"name":"Carry1st","type":"Acquirer"},{"name":"Onafriq","type":"PSP"}],
    "Nigeria":             [{"name":"Paystack by Stripe","type":"Acquirer"},{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"Flutterwave","type":"PSP"},{"name":"Interswitch","type":"PSP"}],
    "Kenya":               [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"Pesapal","type":"PSP"},{"name":"DPO Group","type":"PSP"},{"name":"Cellulant","type":"Gateway"}],
    "Morocco":             [{"name":"Stripe","type":"PSP"},{"name":"Adyen","type":"PSP"},{"name":"CMI","type":"Acquirer"},{"name":"HPS","type":"PSP"},{"name":"Maroc Telecommerce","type":"Gateway"}],
    "Ghana":               [{"name":"Paystack by Stripe","type":"Acquirer"},{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"Hubtel","type":"PSP"},{"name":"ExpressPay","type":"PSP"}],
    ...
    "Tanzania":            [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"Selcom","type":"PSP"},{"name":"Pesapal","type":"PSP"},{"name":"DPO Group","type":"PSP"}],
    "Uganda":              [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"Pesapal","type":"PSP"},{"name":"Flutterwave","type":"PSP"},{"name":"DPO Group","type":"PSP"}],
    ...
    "Senegal":             [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"PayDunya","type":"PSP"},{"name":"CinetPay","type":"PSP"},{"name":"InTouch","type":"PSP"}],
    "Côte d'Ivoire":       [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"PayDunya","type":"PSP"},{"name":"CinetPay","type":"PSP"},{"name":"Wave Business","type":"PSP"}],
    "Cameroon":            [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"PayDunya","type":"PSP"},{"name":"CinetPay","type":"PSP"},{"name":"MFS Africa","type":"PSP"}],
    ...
    "Rwanda":              [{"name":"Onafriq","type":"PSP"},{"name":"Stripe","type":"PSP"},{"name":"Pesapal","type":"PSP"},{"name":"Flutterwave","type":"PSP"},{"name":"Bank of Kigali","type":"Acquirer"}],
